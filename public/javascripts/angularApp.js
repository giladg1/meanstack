...
app.factory('auth', ['$http', '$window', function($http, $window){
    ...
    // Create a register function that posts a user to our /register route on the server and saves the token returned.
    ...
    // Create a login function that posts a user to our /login route on the server and saves the token returned.
